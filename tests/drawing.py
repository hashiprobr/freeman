...
class DrawingTest(unittest.TestCase):
    ...
    def test_draw_digraph_with_node_extra(self):
        fm.draw(self.with_node_extra(self.partial_digraph()))
    ...
    def test_draw_digraph_with_int_node_extra(self):
        self.assertRaises(TypeError, fm.draw, self.with_int_node_extra(self.partial_digraph()))
